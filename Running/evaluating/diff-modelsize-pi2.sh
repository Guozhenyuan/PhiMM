...
rp="Data/results/diff_modelsize_pi2.json"
        ...
        do
            ...
            do
                ...
                do
                    ...
                    # save_dir="$dir_save/diff-modelsize/$m/$d/phishing-pi2/sft-b-phishing/"
        ...
        do
            ...
            do
                ...
                do
                    ...
                    target_model="$dir_merge/diff-modelsize/$m/$d/$mm/sft-b-phishing-cloak/C_${p}_cloak($c)"
                    save_dir="$dir_save/diff-modelsize/$m/$d/cloak/sft-b-phishing-cloak"
