                ...
                do
                    ...
                    do
                        ...
                        do
                            ...
                            B="$dir_train_model_to_save/diff-modelsize/$m/$d/sft-b-phishing/ablation/${p}_lr${lr}_epoch${epoch}"
                            IFS='/' read -ra parts <<< "$B"
                            ...
                            C="$dir_merge/diff-modelsize/$m/$d/$mm/sft-b-phishing/ablation/${p}_lr${lr}_epoch${epoch}"
